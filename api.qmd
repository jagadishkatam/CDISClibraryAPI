...
subtitle: "<br><span style='color:#3F5596; font-weight: bold;font-size:50px'>Pharma</span><span style='color:#8BCE88;font-weight: bold;font-size:50px'>SUG</span> <br><span style='color:black;font-weight: bold;font-size:50px'>Single Day Event</span><br>"
author: "<strong>Jagadish Katam</strong><br>12-Apr-2025"
footer: "<strong>[© 2025 Princeps Technologies All Rights Reserved.](https://www.princepstech.com/)</strong>"
format: 
  revealjs:
    controls: true
    multiplex: true
...
## Agenda {.title-slide .smaller }

<br/>

::: {.fragment style="font-size: 25px; font-family: 'Arial', sans-serif;"}

- CDISC Library <br> 
- API <br> 
- RESTful API <br>
- HTTP Methods <br> 
- Endpoints and Paameters <br> 
- Access the CDISC Library <br> 
- API request via R <br> 
- Extract the Data from JSON file <br>
- Conclusion 
...
-   Types of Application Programming Interface <br/> <br>
    -   Private API <br>
    -   [Public API]{style="font-weight:bold; color:green;"} <br>
    -   Partner API
...
::: {.fragment layout="[[80], [20]]" style="font-size: 25px; font-family: 'Arial', sans-serif;"}

Some of the common HTTP result codes that are often used inside REST APIs are as follows: <br/> <br> 

[200 - "OK"]{style="font-weight:bold; color:green;"} <br> 
201 - "Created" (Used with POST). <br> 
400 - "Bad Request" (Perhaps missing required parameters). <br> 
401 - "Unauthorized" (Missing authentication parameters). <br> 
403 - "Forbidden" (You were authenticated but lacking required privileges). <br> 
[404 - "Not Found"]{style="font-weight:bold;color:red;"}


![](img/rest.png){.fragment fig-align="center" width="700"}
:::
...
![](img/flow.png){fig-align="center" width="1200"}
...
## Extract Controlled Terminology from JSON file {.title-slide .smaller}
...
## Controlled Terminology Data {.title-slide .smaller}
...
-   Aerts, J. (2019). *Implementing the CDISC Library API in software applications: First experiences.* Presented at **PHUSE EU Connect 2019**, Tarrenz, Austria. <br><br>

-   Hinson, J. (2021). *How the R programming language handles the CDISC Library API.* Presented at **PHUSE US Connect 2021**. <br><br>

-   Radelicki, R. (2020). *CDISC Library try-out: From implementation to evaluation of the API.* Presented at **PHUSE US Connect 2020**, Mechelen, Belgium. <br><br>
